...
use think\facade\{
    Config,Session,Log,Request,Cache,Cookie
};
...
function get_cover($cover_id = 0, $fields = '') {
    $default_path=Request::root().'/'.Request::module().'/images/null.gif';
    ...
    if (empty($info)){
        ...
        return $fields ? $info[$fields] : $info['url'] ?: Request::domain().$info['path'];
    }
}
