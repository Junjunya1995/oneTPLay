...
CREATE TABLE `tp5_channel` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='前端导航';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='文档模型基础表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='友情连接表';
...
INSERT INTO `tp5_menu` VALUES ('19', '用户行为', '16', '3', 'Action/index', '0', '', '行为管理', '0', '1');
...
INSERT INTO `tp5_menu` VALUES ('27', '权限管理', '16', '2', 'AuthManager/index', '0', '', '用户管理', '0', '1');
...
INSERT INTO `tp5_menu` VALUES ('108', '修改密码', '16', '7', 'Member/updatePassword', '1', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('109', '修改昵称', '16', '6', 'Member/updateNickname', '1', '', '', '0', '1');
...
INSERT INTO `tp5_menu` VALUES ('188', '内容', '0', '2', 'Article/mydocument', '1', '', '', '0', '1');
...
INSERT INTO `tp5_menu` VALUES ('191', '网站配置', '187', '2', 'Deploy/group', '0', '', '系统设置', '0', '1');
INSERT INTO `tp5_menu` VALUES ('196', '行为日志', '16', '4', 'Action/actionlog', '0', '', '行为管理', '0', '1');
INSERT INTO `tp5_menu` VALUES ('197', '备份数据库', '187', '6', 'DataBase/index', '0', '', '数据备份', '0', '1');
INSERT INTO `tp5_menu` VALUES ('198', '数据备份', '197', '0', 'DataBase/export', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('201', '还原数据库', '187', '5', 'DataBase/import', '0', '', '数据备份', '0', '1');
INSERT INTO `tp5_menu` VALUES ('202', '备份数据还原', '201', '0', 'DataBase/revert', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('203', '备份数据删除', '201', '0', 'DataBase/del', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('204', '导航菜单', '187', '4', 'Channel/index', '0', '', '系统设置', '0', '1');
INSERT INTO `tp5_menu` VALUES ('205', '配置管理', '187', '1', 'Deploy/index', '0', '', '系统设置', '0', '1');
INSERT INTO `tp5_menu` VALUES ('206', '日志详情', '196', '0', 'Action/detailed', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('207', '分类管理', '187', '3', 'Category/index', '0', '', '系统设置', '0', '1');
...
INSERT INTO `tp5_menu` VALUES ('220', '批量更新(启用、禁用、删除)', '17', '0', 'Member/batchUpdate', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('221', '授权', '17', '0', 'AuthManager/group', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('222', '单个更新（启用、禁用、删除）', '17', '0', 'Member/setStatus', '0', '', '', '0', '1');
...
INSERT INTO `tp5_menu` VALUES ('227', '修改头像', '16', '5', 'Personal/portrait', '0', '', '', '0', '1');
...
INSERT INTO `tp5_menu` VALUES ('248', '运营', '0', '5', 'Operation/index', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('249', '运营统计', '248', '0', 'Operation/index', '0', '', '常规', '0', '1');
INSERT INTO `tp5_menu` VALUES ('250', '友情链接', '248', '0', 'Links/index', '0', '', '常规', '0', '1');
INSERT INTO `tp5_menu` VALUES ('251', '通知公告', '248', '0', 'Notice/index', '0', '', '常规', '0', '1');
INSERT INTO `tp5_menu` VALUES ('252', '编辑', '204', '0', 'Channel/edit', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('253', '编辑', '207', '0', 'Category/edit', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('254', '新增用户', '17', '0', 'Member/add', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('255', '用户数据接口', '17', '0', 'Member/userJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('256', '权限管理数据', '27', '0', 'AuthManager/authJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('257', '用户组授权用户数据', '27', '0', 'AuthManager/userJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('258', '用户添加到用户组', '27', '0', 'AuthManager/userToGroup', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('259', '用户行为数据', '19', '0', 'Action/actionJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('260', '用户行为日志数据', '196', '0', 'Action/actionLogJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('261', '图片上传', '227', '0', 'Personal/submitPortrait', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('262', '修改昵称提交', '109', '0', 'Personal/submitNickname', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('263', '修改密码提交', '108', '0', 'Personal/submitPassword', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('264', '配置数据', '205', '0', 'Deploy/deployJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('266', '移动分类', '207', '0', 'Category/moveRenew', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('267', '分类图片上传', '207', '0', 'Category/categoryPicture', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('268', '导航列表数据', '204', '0', 'Channel/channelJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('269', '菜单列表数据', '75', '0', 'Menu/menuJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('270', '更新或者添加', '75', '0', 'Menu/renew', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('273', '友情链接数据', '250', '0', 'Links/linksJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('274', '更新排序', '250', '0', 'Links/sequence', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('275', '导航详情', '250', '0', 'Links/edit', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('276', '更新或者添加链接', '250', '0', 'Links/renew', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('277', '公告数据列表', '251', '0', 'Notice/noticeJson', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('278', '公告详情', '251', '0', 'Notice/edit', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('279', '更新或者添加公告', '251', '0', 'Notice/renew', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('280', '图片上传', '251', '0', 'Notice/fileUpload', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('281', '附件上传', '251', '0', 'Notice/annex', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('282', '批量数据变更', '250', '0', 'Links/batchUpdate', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('283', '单个数据变更', '250', '0', 'Links/setStatus', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('284', '单个数据变更', '251', '0', 'Notice/setStatus', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('285', '批量数据变更', '251', '0', 'Notice/batchUpdate', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('286', '保存用户授权', '17', '0', 'AuthManager/userToGroup', '0', '', '', '0', '1');
INSERT INTO `tp5_menu` VALUES ('287', '保存用户', '17', '0', 'Member/renew', '0', '', '', '0', '1');
...
CREATE TABLE `tp5_notice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='系统版本表';
